...
test("route coverage matrix exercises stocks and crypto endpoints", async (t) => {
  ...
  const cases: Array<{ method?: string; path: string; status: number }> = [
    ...
    { path: "/api/v1/stocks/indices/snapshot/2026-03-12", status: 200 },
    { path: "/api/v1/stocks/indices/snapshot/bad-date", status: 400 },
    { path: "/api/v1/stocks/indices/snapshot/final/2026-03-12", status: 200 },
    { path: "/api/v1/stocks/indices/history?range=1m", status: 200 },
    { path: "/api/v1/stocks/indices/history?range=bad", status: 400 },
    { path: "/api/v1/stocks/indices/summary/intraday/latest", status: 200 },
    { path: "/api/v1/stocks/indices/summary/final/latest", status: 200 },
    { path: "/api/v1/stocks/indices/summary/final/2026-03-12", status: 200 },
