...
export function HomeContentTabs(props: HomeContentTabsProps) {
  const { lang, date, readableDate, rows, overview, newsGroups, reportMeta, sectionIds } = props;
  ...
  return (
    <div className="home-content-stack">
      <div className="space-y-4">
        <section id={resolvedSectionIds.featured} className="scroll-mt-24">
        ...
        <section id={resolvedSectionIds.report} className="scroll-mt-24">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <section id={resolvedSectionIds.movers} className="scroll-mt-24">
                <HomeMoversPanel lang={lang} rows={rows} />
              </section>

              <section id={resolvedSectionIds.news} className="scroll-mt-24 space-y-3">
                <div className="flex items-center justify-between gap-2">
